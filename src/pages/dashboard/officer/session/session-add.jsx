...
import { addSessionValid, addSingleSession } from "@/services/sessionService";
...
export default function OfficerAddSessionPage() {
  ...
  // Update lecturer name when class changes
  useEffect(() => {
    if (formData.classId) {
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2 col-span-2">
                    <Label>Date</Label>
                    <CalendarSelector mode="single" selectedDate={formData.sessionDate || undefined} setSelectedDate={handleDateChange} className="w-full" disable={isValidating} />
                  </div>
                </div>
