...
export function OfficerAttendanceClassList({ classes, onSelectClass, onSelectReport }) {
      ...
      {classes.map((classItem) => (
        <Card key={classItem.classId} className={"border-primary"}>
          <CardHeader>
            ...
            <CardDescription>{classItem.scheduled ? 'Already Scheduled' : 'Not Schedule Yet' || "No schedule information"}</CardDescription>
          </CardHeader>
          <CardContent>
