  ...
  return (
    <div className="relative w-full h-full">
      {Array.from({ length: count }).map((_, i) => (
        ...
        >
          <div className="relative w-16 h-20 bg-primary/10 backdrop-blur-sm rounded-lg border border-primary/10 flex items-center justify-center transform hover:scale-110 transition-transform">
